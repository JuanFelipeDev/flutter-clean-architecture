...
class BeneficiaryDto {
  ...
  factory BeneficiaryDto.fromJson(Map<String, dynamic> json) {
    ...
    return BeneficiaryDto(
      ...
      relationship:
          json['relationship']?.toString() ?? json['parentesco']?.toString(),
      documentNumber:
...
BeneficiaryDto? parseBeneficiary(dynamic body) =>
    _single(body, BeneficiaryDto.fromJson);

/// DTOs + mapper for profile (AFILIADO `ClientProfile` / `PerfilDataResponse` /
...
class AffiliateProfileDto {
  ...
  factory AffiliateProfileDto.fromJson(Map<String, dynamic> json) => AffiliateProfileDto(
        affKey: json['affKey']?.toString() ?? json['affkey']?.toString() ?? json['cve_afiliado']?.toString(),
        firstName: json['affFirstName']?.toString() ?? json['firstName']?.toString() ?? json['nombre']?.toString(),
        firstSurname: json['affFirstSurname']?.toString() ?? json['firstSurname']?.toString() ?? json['apellido']?.toString(),
        email: json['email']?.toString() ?? json['correo']?.toString(),
        phone: json['phone']?.toString() ?? json['telefono']?.toString(),
        documentTypeId: json['documentTypeId']?.toString() ?? json['id_tipo_documento']?.toString(),
        documentNumber: json['documentNumber']?.toString() ?? json['numero_documento']?.toString(),
        photoUrl: json['photoUrl']?.toString() ?? json['foto_afiliado']?.toString(),
...
class DocumentTypeDto {
  ...
  factory DocumentTypeDto.fromJson(Map<String, dynamic> json) => DocumentTypeDto(
        ...
        name: json['name']?.toString() ?? json['tipoDocumento']?.toString() ?? json['descripcion']?.toString(),
      );
}
...
class CompanyDto {
  ...
  factory CompanyDto.fromJson(Map<String, dynamic> json) => CompanyDto(
        ...
        name: json['name']?.toString() ?? json['companyName']?.toString() ?? json['nombre']?.toString(),
      );
}
...
class ProfileMapper {
  ...
  DocumentType toDocumentType(DocumentTypeDto dto) => DocumentType(id: dto.id ?? '', name: dto.name ?? '');
  Company toCompany(CompanyDto dto) => Company(id: dto.id ?? '', name: dto.name ?? '');
}
...
List<T> _parseList<T>(dynamic body, T Function(Map<String, dynamic>) fromJson, [String? key]) {
...
AffiliateProfileDto? parseProfile(dynamic body) => _parseSingle(body, AffiliateProfileDto.fromJson);
List<DocumentTypeDto> parseDocumentTypes(dynamic body) =>
    _parseList(body, DocumentTypeDto.fromJson, 'types');
List<CompanyDto> parseCompanies(dynamic body) => _parseList(body, CompanyDto.fromJson, 'companies');
...
class ChatMessageDto {
  ...
  factory ChatMessageDto.fromJson(Map<String, dynamic> json) => ChatMessageDto(
    ...
    assistanceId:
        json['assistanceId']?.toString() ?? json['idasistencia']?.toString(),
...
class ChatMapper {
  ...
  ChatMessage? toEntityFromSocket(Map<String, dynamic> payload) {
    final content =
        payload['msContent']?.toString() ?? payload['content']?.toString();
    ...
    return ChatMessage(
      ...
      typeUser:
          payload['msTypeUser']?.toString() ??
          payload['typeUser']?.toString() ??
          'prov',
      createdAt: _parseDate(
        payload['msCreatedAt']?.toString() ?? payload['createdAt']?.toString(),
      ),
    );
  }
